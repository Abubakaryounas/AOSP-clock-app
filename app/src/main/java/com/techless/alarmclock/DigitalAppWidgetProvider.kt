 ...
 * the License.
 */
package com.techless.alarmclock
...
import com.techless.clock.worldclock.CitySelectionActivity
...
class DigitalAppWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
         ...
         */
        private const val ACTION_ON_DAY_CHANGE = "com.techless.clock.ON_DAY_CHANGE"
