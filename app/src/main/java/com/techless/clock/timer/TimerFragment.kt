...
package com.techless.clock.timer
...
import com.techless.clock.data.TimerListener
import com.techless.clock.data.TimerStringFormatter
...
class TimerFragment : DeskClockFragment(UiDataModel.Tab.TIMERS) {
    ...
    companion object {
        private const val EXTRA_TIMER_SETUP = "com.techless.clock.action.TIMER_SETUP"
