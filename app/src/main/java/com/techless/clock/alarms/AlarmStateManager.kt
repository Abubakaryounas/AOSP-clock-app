...
package com.techless.clock.alarms
...
import com.techless.clock.AlarmAlertWakeLock
import com.techless.clock.AlarmClockFragment
import com.techless.clock.AlarmUtils
import com.techless.clock.AsyncHandler
import com.techless.clock.DeskClock
...
import com.techless.clock.provider.ClockContract.InstancesColumns
...
class AlarmStateManager : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_ALARM_CHANGED = "com.techless.clock.ALARM_CHANGED"
