...
import com.techless.clock.widget.selector.AlarmSelection
import com.techless.clock.widget.selector.AlarmSelectionAdapter
...
class AlarmSelectionActivity : ListActivity() {
    ...
    companion object {
        ...
        const val EXTRA_ACTION = "com.techless.clock.EXTRA_ACTION"
        const val EXTRA_ALARMS = "com.techless.clock.EXTRA_ALARMS"
    }
}